 ...
 * @param data The specific dataset to hydrate (e.g., projects).
 * @param sheetKey The key of the sheet for the data being hydrated.
 * @param allData A store of all fetched sheet data for lookups.
 * @returns The hydrated data array.
 */
