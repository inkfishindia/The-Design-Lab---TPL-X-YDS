...
export const MarketingView: React.FC<MarketingViewProps> = ({ isAuthenticated, token, user }) => {
  ...
  const researchWidget = (
    <WidgetCard title="Customer & Competitor Research" icon={<CompetitorIcon className="w-6 h-6" />}>
   ...
   const strategyWidget = (
    <WidgetCard title="Strategy & Ideation" icon={<StrategyIcon className="w-6 h-6" />}>
        <div className="p-4 overflow-y-auto h-full">
  ...
  const creationWidget = (
     <WidgetCard title="Content Creation" icon={<SparklesIcon className="w-6 h-6" />}>
        <div className="p-4 overflow-y-auto h-full">
  ...
  const analyticsWidget = (
    <WidgetCard title="Analytics" icon={<LookerStudioIcon className="w-6 h-6" />}>
      <div className="p-4 overflow-y-auto h-full">
  ...
  return (
    <div className="h-full w-full flex flex-col bg-cream text-midnight-navy">
      <div className="flex-shrink-0 text-center pt-6 px-6">
        <h1 className="text-3xl font-display font-bold text-midnight-navy">Marketing Suite</h1>
        <p className="mt-2 text-lg text-midnight-navy/70">Your central command for market analysis, content creation, and strategic planning.</p>
      </div>
